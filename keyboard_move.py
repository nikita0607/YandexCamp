...
def init():
    ...
    kb.add_hotkey('w', lambda: (print("A"), Movement().move_sync(1)))
    kb.add_hotkey('s', lambda: Movement().move_sync(2))
    kb.add_hotkey('a', lambda: Movement().move_sync(3))
    kb.add_hotkey('d', lambda: Movement().move_sync(4))
    ...
    kb.add_hotkey('0', lambda: Movement.set_speed(40))
